...
func (UnimplementedPublisherServer) ListTopicSubscriptions(context.Context, *ListTopicSubscriptionsRequest) (*ListTopicSubscriptionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListTopicSubscriptions not implemented")
}
func (UnimplementedPublisherServer) ListTopicSnapshots(context.Context, *ListTopicSnapshotsRequest) (*ListTopicSnapshotsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListTopicSnapshots not implemented")
}
...
func (UnimplementedPublisherServer) DetachSubscription(context.Context, *DetachSubscriptionRequest) (*DetachSubscriptionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DetachSubscription not implemented")
}
...
// UnimplementedSubscriberServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedSubscriberServer) ModifyAckDeadline(context.Context, *ModifyAckDeadlineRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ModifyAckDeadline not implemented")
}
...
func (UnimplementedSubscriberServer) StreamingPull(grpc.BidiStreamingServer[StreamingPullRequest, StreamingPullResponse]) error {
	return status.Error(codes.Unimplemented, "method StreamingPull not implemented")
}
func (UnimplementedSubscriberServer) ModifyPushConfig(context.Context, *ModifyPushConfigRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ModifyPushConfig not implemented")
}
...
func (UnimplementedSubscriberServer) UpdateSnapshot(context.Context, *UpdateSnapshotRequest) (*Snapshot, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateSnapshot not implemented")
}
