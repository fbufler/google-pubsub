...
func request_Subscriber_StreamingPull_0(ctx context.Context, marshaler runtime.Marshaler, client SubscriberClient, req *http.Request, pathParams map[string]string) (Subscriber_StreamingPullClient, runtime.ServerMetadata, error) {
	...
	handleSend := func() error {
		var protoReq StreamingPullRequest
...
func RegisterSubscriberHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SubscriberServer) error {
	...
	mux.Handle(http.MethodPost, pattern_Subscriber_StreamingPull_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterSubscriberHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SubscriberClient) error {
	...
	mux.Handle(http.MethodPost, pattern_Subscriber_StreamingPull_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/google.pubsub.v1.Subscriber/StreamingPull", runtime.WithHTTPPathPattern("/google.pubsub.v1.Subscriber/StreamingPull"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Subscriber_StreamingPull_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		}
		forward_Subscriber_StreamingPull_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodPost, pattern_Subscriber_ModifyPushConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
...
var (
	...
	pattern_Subscriber_StreamingPull_0      = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"google.pubsub.v1.Subscriber", "StreamingPull"}, ""))
...
var (
	...
	forward_Subscriber_StreamingPull_0      = runtime.ForwardResponseStream
